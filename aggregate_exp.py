...
def main(args):
    ...
    for exp_dir in exp_dirs:
        ...
        df = load_all_chunks(exp_dir, ignore_suffixes=IGNORED_SEGMENTS)
        if df.empty:
            print("[EMPTY / NO DATA]")
            continue
    ...
    print("\n" + "="*140)
    print("GLOBAL SUMMARY (Sorted by Raw MSE)")
    print("="*140)
    ...
    suffix = "_filtered" if (args.start_date or args.end_date) else ""
    output_file = os.path.join(args.base_dir, f"global_results_summary{suffix}.csv")
