...
from data_sqrt import load_and_prep_data_strided, get_chunk_indices_strided, save_chunk_results
...
def main(args):
    ...
    X_np, y_np, dates, baselines = load_and_prep_data_strided(hparams, "all30min.csv")
