...
from projects.dl.backtest.gpu_kernels import make_ae_train_kernel, make_train_kernel
from projects.dl.backtest.gpu_utils import (
    allocate_params,
    init_adam_state,
    load_model,
    log_to_file,
...
def _ae_ridge_worker(
    ...
    def setup_fn(device):
        base_model_train, base_model_eval, buffers, param_keys = load_model(
            "projects.dl.models.deep_learning", "get_ae_model", model_config, device
        )
