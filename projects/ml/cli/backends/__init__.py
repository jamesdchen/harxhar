...
Usage:
    from projects.ml.cli.backends import get_backend
...
class HPCBackend(abc.ABC):
    ...
    def submit_array(
        ...
        """Submit an array job. Each task runs projects.ml.cli.executor with a chunk ID."""
        ...
...
def get_backend(name: str = "slurm", **kwargs) -> HPCBackend:
    ...
    from projects.ml.cli.backends import sge as _sge  # noqa: F401
    from projects.ml.cli.backends import slurm as _slurm  # noqa: F401
