...
interaction is handled by pluggable backends (see harxhar_ml.cli.backends).
"""
...
# Resolve paths relative to the ml package root (four levels up from src/harxhar_ml/cli/submit.py)
