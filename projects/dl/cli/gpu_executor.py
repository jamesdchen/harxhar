...
Usage:
    ...
    python -m projects.dl.cli.gpu_executor --experiment ae_ridge --gpu-count 4
    python -m projects.dl.cli.gpu_executor --experiment patchts --output results_dl.csv
"""
...
from projects.dl.config import AE_RIDGE_GPU_CONFIG, DL_CONFIG
...
def _run_ae_ridge(args: argparse.Namespace) -> None:
    ...
    from projects.dl.backtest.gpu_engine import run_ae_multigpu_backtest
